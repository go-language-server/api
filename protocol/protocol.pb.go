...
func (x *StaticRegistrationOptions) GetId() *wrapperspb.StringValue {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *TextDocumentRegistrationOptions) GetEmpty() structpb.NullValue {
...
func (x *WorkDoneProgressReport) GetMessage() *wrapperspb.StringValue {
	if x != nil {
		return x.Message
	}
	return nil
